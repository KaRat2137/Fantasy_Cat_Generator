 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kt=()=>Mt().__FIREBASE_DEFAULTS__,$t=()=>{if(typeof process>"u"||typeof process.env>"u")return;const t={}.__FIREBASE_DEFAULTS__;if(t)return JSON.parse(t)},Lt=()=>{if(typeof document>"u")return;let t;try{t=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=t&&Ot(t[1]);return e&&JSON.parse(e)},Nt=()=>{try{return kt()||$t()||Lt()}catch(t){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${t}`);return}},Vt=()=>{var t;return(t=Nt())===null||t===void 0?void 0:t.config};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const R=new en("@firebase/app"),mn="@firebase/app-compat",gn="@firebase/analytics-compat",yn="@firebase/analytics",bn="@firebase/app-check-compat",_n="@firebase/app-check",wn="@firebase/auth",Sn="@firebase/auth-compat",En="@firebase/database",Cn="@firebase/database-compat",vn="@firebase/functions",xn="@firebase/functions-compat",Tn="@firebase/installations",In="@firebase/installations-compat",An="@firebase/messaging",Pn="@firebase/messaging-compat",Dn="@firebase/performance",Rn="@firebase/performance-compat",Bn="@firebase/remote-config",On="@firebase/remote-config-compat",Mn="@firebase/storage",kn="@firebase/storage-compat",$n="@firebase/firestore",Ln="@firebase/firestore-compat",Nn="firebase";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vn="[DEFAULT]",Fn={[ce]:"fire-core",[mn]:"fire-core-compat",[yn]:"fire-analytics",[gn]:"fire-analytics-compat",[_n]:"fire-app-check",[bn]:"fire-app-check-compat",[wn]:"fire-auth",[Sn]:"fire-auth-compat",[En]:"fire-rtdb",[Cn]:"fire-rtdb-compat",[vn]:"fire-fn",[xn]:"fire-fn-compat",[Tn]:"fire-iid",[In]:"fire-iid-compat",[An]:"fire-fcm",[Pn]:"fire-fcm-compat",[Dn]:"fire-perf",[Rn]:"fire-perf-compat",[Bn]:"fire-rc",[On]:"fire-rc-compat",[Mn]:"fire-gcs",[kn]:"fire-gcs-compat",[$n]:"fire-fst",[Ln]:"fire-fst-compat","fire-js":"fire-js",[Nn]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zn="firebase-heartbeat-database",Gn=1,L="firebase-heartbeat-store";let Z=null;function it(){return Z||(Z=hn(zn,Gn,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(L)}}}).catch(t=>{throw D.create("idb-open",{originalErrorMessage:t.message})})),Z}async function qn(t){try{return await(await it()).transaction(L).objectStore(L).get(at(t))}catch(e){if(e instanceof F)R.warn(e.message);else{const n=D.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});R.warn(n.message)}}}async function Me(t,e){try{const r=(await it()).transaction(L,"readwrite");await r.objectStore(L).put(e,at(t)),await r.done}catch(n){if(n instanceof F)R.warn(n.message);else{const r=D.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});R.warn(r.message)}}}function at(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */const We=typeof window<"u"&&window.customElements!=null&&window.customElements.polyfillWrapFlushCallback!==void 0,Ce=(t,e,n=null)=>{for(;e!==n;){const r=e.nextSibling;t.removeChild(e),e=r}};/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const x=`{{lit-${String(Math.random()).slice(2)}}}`,pt=`<!--${x}-->`,ze=new RegExp(`${x}|${pt}`),k="$lit$";class mt{constructor(e,n){this.parts=[],this.element=n;const r=[],s=[],i=document.createTreeWalker(n.content,133,null,!1);let a=0,o=-1,c=0;const{strings:u,values:{length:m}}=e;for(;c<m;){const d=i.nextNode();if(d===null){i.currentNode=s.pop();continue}if(o++,d.nodeType===1){if(d.hasAttributes()){const g=d.attributes,{length:S}=g;let E=0;for(let w=0;w<S;w++)Ge(g[w].name,k)&&E++;for(;E-- >0;){const w=u[c],B=fe.exec(w)[2],O=B.toLowerCase()+k,A=d.getAttribute(O);d.removeAttribute(O);const C=A.split(ze);this.parts.push({type:"attribute",index:o,name:B,strings:C}),c+=C.length-1}}d.tagName==="TEMPLATE"&&(s.push(d),i.currentNode=d.content)}else if(d.nodeType===3){const g=d.data;if(g.indexOf(x)>=0){const S=d.parentNode,E=g.split(ze),w=E.length-1;for(let B=0;B<w;B++){let O,A=E[B];if(A==="")O=T();else{const C=fe.exec(A);C!==null&&Ge(C[2],k)&&(A=A.slice(0,C.index)+C[1]+C[2].slice(0,-k.length)+C[3]),O=document.createTextNode(A)}S.insertBefore(O,d),this.parts.push({type:"node",index:++o})}E[w]===""?(S.insertBefore(T(),d),r.push(d)):d.data=E[w],c+=w}}else if(d.nodeType===8)if(d.data===x){const g=d.parentNode;(d.previousSibling===null||o===a)&&(o++,g.insertBefore(T(),d)),a=o,this.parts.push({type:"node",index:o}),d.nextSibling===null?d.data="":(r.push(d),o--),c++}else{let g=-1;for(;(g=d.data.indexOf(x,g+1))!==-1;)this.parts.push({type:"node",index:-1}),c++}}for(const d of r)d.parentNode.removeChild(d)}}const Ge=(t,e)=>{const n=t.length-e.length;return n>=0&&t.slice(n)===e},gt=t=>t.index!==-1,T=()=>document.createComment(""),fe=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const ve=133;function yt(t,e){const{element:{content:n},parts:r}=t,s=document.createTreeWalker(n,ve,null,!1);let i=$(r),a=r[i],o=-1,c=0;const u=[];let m=null;for(;s.nextNode();){o++;const d=s.currentNode;for(d.previousSibling===m&&(m=null),e.has(d)&&(u.push(d),m===null&&(m=d)),m!==null&&c++;a!==void 0&&a.index===o;)a.index=m!==null?-1:a.index-c,i=$(r,i),a=r[i]}u.forEach(d=>d.parentNode.removeChild(d))}const qr=t=>{let e=t.nodeType===11?0:1;const n=document.createTreeWalker(t,ve,null,!1);for(;n.nextNode();)e++;return e},$=(t,e=-1)=>{for(let n=e+1;n<t.length;n++){const r=t[n];if(gt(r))return n}return-1};function Kr(t,e,n=null){const{element:{content:r},parts:s}=t;if(n==null){r.appendChild(e);return}const i=document.createTreeWalker(r,ve,null,!1);let a=$(s),o=0,c=-1;for(;i.nextNode();)for(c++,i.currentNode===n&&(o=qr(e),n.parentNode.insertBefore(e,n));a!==-1&&s[a].index===c;){if(o>0){for(;a!==-1;)s[a].index+=o,a=$(s,a);return}a=$(s,a)}}/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const Jr=new WeakMap,N=t=>typeof t=="function"&&Jr.has(t);/**
 * @license
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const M=new WeakMap,rs=(t,e,n)=>{let r=M.get(e);r===void 0&&(Ce(e,e.firstChild),M.set(e,r=new K(Object.assign({templateFactory:ns},n))),r.appendInto(e)),r.setValue(t),r.commit()};/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const Et=(t,e)=>`${t}--${e}`;let G=!0;typeof window.ShadyCSS>"u"?G=!1:typeof window.ShadyCSS.prepareTemplateDom>"u"&&(console.warn("Incompatible ShadyCSS version detected. Please update to at least @webcomponents/webcomponentsjs@2.0.2 and @webcomponents/shadycss@1.3.1."),G=!1);const os=t=>e=>{const n=Et(e.type,t);let r=V.get(n);r===void 0&&(r={stringsArray:new WeakMap,keyString:new Map},V.set(n,r));let s=r.stringsArray.get(e.strings);if(s!==void 0)return s;const i=e.strings.join(x);if(s=r.keyString.get(i),s===void 0){const a=e.getTemplateElement();G&&window.ShadyCSS.prepareTemplateDom(a,t),s=new mt(e,a),r.keyString.set(i,s)}return r.stringsArray.set(e.strings,s),s},cs=["html","svg"],ls=t=>{cs.forEach(e=>{const n=V.get(Et(e,t));n!==void 0&&n.keyString.forEach(r=>{const{element:{content:s}}=r,i=new Set;Array.from(s.querySelectorAll("style")).forEach(a=>{i.add(a)}),yt(r,i)})})},Ct=new Set,hs=(t,e,n)=>{Ct.add(t);const r=n?n.element:document.createElement("template"),s=e.querySelectorAll("style"),{length:i}=s;if(i===0){window.ShadyCSS.prepareTemplateStyles(r,t);return}const a=document.createElement("style");for(let u=0;u<i;u++){const m=s[u];m.parentNode.removeChild(m),a.textContent+=m.textContent}ls(t);const o=r.content;n?Kr(n,a,o.firstChild):o.insertBefore(a,o.firstChild),window.ShadyCSS.prepareTemplateStyles(r,t);const c=o.querySelector("style");if(window.ShadyCSS.nativeShadow&&c!==null)e.insertBefore(c.cloneNode(!0),e.firstChild);else if(n){o.insertBefore(a,o.firstChild);const u=new Set;u.add(a),yt(n,u)}},ds=(t,e,n)=>{if(!n||typeof n!="object"||!n.scopeName)throw new Error("The `scopeName` option is required.");const r=n.scopeName,s=M.has(e),i=G&&e.nodeType===11&&!!e.host,a=i&&!Ct.has(r),o=a?document.createDocumentFragment():e;if(rs(t,o,Object.assign({templateFactory:os(r)},n)),a){const c=M.get(o);M.delete(o);const u=c.value instanceof pe?c.value.template:void 0;hs(r,o,u),Ce(e,e.firstChild),e.appendChild(o),M.set(e,c)}!s&&i&&window.ShadyCSS.styleElement(e.host)};/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
 ...
 */(window.litElementVersions||(window.litElementVersions=[])).push("2.4.0");const Je={};class Ae extends Tt{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const e=this.getStyles();if(Array.isArray(e)){const n=(i,a)=>i.reduceRight((o,c)=>Array.isArray(c)?n(c,o):(o.add(c),o),a),r=n(e,new Set),s=[];r.forEach(i=>s.unshift(i)),this._styles=s}else this._styles=e===void 0?[]:[e];this._styles=this._styles.map(n=>{if(n instanceof CSSStyleSheet&&!be){const r=Array.prototype.slice.call(n.cssRules).reduce((s,i)=>s+i.cssText,"");return us(r)}return n})}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const e=this.constructor._styles;e.length!==0&&(window.ShadyCSS!==void 0&&!window.ShadyCSS.nativeShadow?window.ShadyCSS.ScopingShim.prepareAdoptedCssText(e.map(n=>n.cssText),this.localName):be?this.renderRoot.adoptedStyleSheets=e.map(n=>n instanceof CSSStyleSheet?n:n.styleSheet):this._needsShimAdoptedStyleSheets=!0)}connectedCallback(){super.connectedCallback(),this.hasUpdated&&window.ShadyCSS!==void 0&&window.ShadyCSS.styleElement(this)}update(e){const n=this.render();super.update(e),n!==Je&&this.constructor.render(n,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(r=>{const s=document.createElement("style");s.textContent=r.cssText,this.renderRoot.appendChild(s)}))}render(){return Je}}Ae.finalized=!0;Ae.render=ds;const ms=t=>class extends t{static get properties(){return{text:{type:String}}}constructor(){super()}};class gs extends ms(Ae){static get styles(){return ps`
    ...
    `}render(){return as`<i><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div></i>`}}window.customElements.define("simple-loader",gs);const Xe=["S","Sp","T'","T'p","Saav","Sav","Synn","Ser","H","J","V","L","N","B","D","K","E","A","F","T","W","G","M","C","R","P","Z","Zel","Ger","Arag","Gord","Lun","Bas","Leg","Arw","Yenn","Jasp","Fr","Dar","Wan","Fynn","Fann","Tann","Mar","Mer","Gwen","Rynn","Rhen","Lap","Rub","Saph","Seth","Raph","Luc","Maw","Mir","Min","Car","Cah","Har","Tr","Mer","Tor","El","Rh","Gwynn","Hel","Th","Dor","Gl","Ber","Lep","Rin","Valh","Cal"],ys=["a","o","e","i","y","u","ae","io","ei","ie","ai","au"],bs=["q","z","x","t","n","g","s","k","r","l","i","e","h","d","u","ng","don","lt","zee","ji","to","wen","gwen","byn","dor","fer","ko","mo","","no","las","wyn","myn","lys","lon","gon","wan","lynn","ck","log","phin","gold","ss","viel","vel","val","lian","ran","ron","ctra","brina","lina","na","vax","lax","nus","ni","niel","tian","fel","kian","rhys","vys","vas","fiel","fal","rin","lla","nthe","var","vor","ri","rion","tia","rys","ger"],_s=["Mage","Warrior","Thief","Archer","Healer","Bard","Witcher","Berserker","Necromancer","Cowcat","Druid"],ws=["Vulcan","Mercat","Vampire","Elf","Fairy","House Cat","Lynx","Goblin"],Ss=["Ger","Mor","Mord","Kazar","Torr","Dor","Far","Vallh","Nor","Por","Mirv","Mir","Kaer","Narh","Vol","Nil","Niv","Rov","Pov","Vars","Vorg","Varg","Tren","Vren","Trint","Ott","Van","Gwen","Tir","Bren","Lys","Hwyr"],Es=["udo","ia","ion","or","un","oria","aria","illa","ola","yin","alla","ir","aw","av","au","ar","au","ou","æn","ein","ain","ean"],Ye=["Swamp","Islands","Lake","Desert","Plains","Mountains","Meadow","City","Village","Forest","Castle","Ranch"],Cs=["White","Orange","Brown","Black","Light brown","Purple","Blue","Green"];let vs=document.getElementById("cat"),xs=document.getElementById("catclass"),Ts=document.getElementById("catrace"),Is=document.getElementById("generate-button"),It=document.getElementById("cat-canvas").getContext("2d"),_e=document.getElementById("cat-container"),At=document.getElementById("download-button"),Ze=document.getElementById("loading-element"),h=[],l={};Os()&&(At.style="display: none;");function Pt(){Rs(),l=Ps(),l.origin[2].trim()=="Desert"&&h.push("images/backgrounds/Desert.png"),l.origin[2].trim()=="Swamp"&&h.push("images/backgrounds/Swamp.png"),l.origin[2].trim()=="Lake"&&h.push("images/backgrounds/Lake.png"),l.origin[2].trim()=="Meadow"&&h.push("images/backgrounds/Meadow.png"),l.origin[2].trim()=="Castle"&&h.push("images/backgrounds/Castle.png"),l.origin[2].trim()=="Islands"&&h.push("images/backgrounds/Islands.png"),l.origin[2].trim()=="Plains"&&h.push("images/backgrounds/Plains.png"),l.origin[2].trim()=="Village"&&h.push("images/backgrounds/Village.png"),l.origin[2].trim()=="City"&&h.push("images/backgrounds/City.png"),l.origin[2].trim()=="Forest"&&h.push("images/backgrounds/Forest.png"),l.origin[2].trim()=="Mountains"&&h.push("images/backgrounds/Mountains.png"),l.origin[2].trim()=="Ranch"&&h.push("images/backgrounds/Ranch.png"),h.push("images/shadow.png"),l.class=="Archer"&&h.push("images/classes//Archer_bow.png"),l.class=="Cowcat"&&h.push("images/classes//Cowcat_lasso.png"),l.class=="Witcher"&&h.push("images/classes//Witcher_swords.png"),l.class=="Bard"&&h.push("images/classes//Bard.png"),l.class=="Warrior"&&h.push(`images/classes/Warrior_${f(3)+1}.png`),l.class=="Healer"&&h.push(`images/classes/Healer_flowers_${f(2)+1}.png`),l.race=="Fairy"&&h.push(`images/races/Fairy_${f(5)+1}.png`),l.colour=="White"&&h.push("images/body/skin_01.png"),l.colour=="Orange"&&h.push("images/body/skin_02.png"),l.colour=="Brown"&&h.push("images/body/skin_03.png"),l.colour=="Black"&&h.push("images/body/skin_04.png"),l.colour=="Light brown"&&h.push("images/body/skin_05.png"),l.colour=="Purple"&&h.push("images/body/skin_06.png"),l.colour=="Blue"&&h.push("images/body/skin_07.png"),l.colour=="Green"&&h.push("images/body/skin_08.png"),h.push(`images/body/spot_${f(17)+1}.png`),h.push(`images/body/marking_${f(13)+1}.png`),h.push("images/body/outline.png"),h.push(`images/body/eye_colour_${f(17)+1}.png`),h.push(`images/body/eye_shape_${f(14)+1}.png`),h.push("images/body/mouth.png"),h.push(`images/body/mouth_add_0${f(4)+1}.png`),l.race=="Lynx"&&h.push("images/races//Lynx.png"),l.race=="Vulcan"&&h.push("images/races//Vulcan.png"),l.race=="Goblin"&&h.push("images/races//Goblin.png"),l.race=="Vampire"&&h.push("images/races//Vampire.png"),l.race=="Elf"&&l.colour=="White"&&h.push("images/races//Elf_white.png"),l.race=="Elf"&&l.colour=="Orange"&&h.push("images/races//Elf_orange.png"),l.race=="Elf"&&l.colour=="Brown"&&h.push("images/races//Elf_brown.png"),l.race=="Elf"&&l.colour=="Black"&&h.push("images/races//Elf_black.png"),l.race=="Elf"&&l.colour=="Light brown"&&h.push("images/races//Elf_brown_light.png"),l.race=="Elf"&&l.colour=="Purple"&&h.push("images/races//Elf_purple.png"),l.race=="Elf"&&l.colour=="Blue"&&h.push("images/races//Elf_blue.png"),l.race=="Elf"&&l.colour=="Green"&&h.push("images/races//Elf_green.png"),l.class=="Berserker"&&h.push(`images/classes/Berserker_${f(3)+1}.png`),l.class=="Mage"&&h.push(`images/classes/Mage_${f(5)+1}.png`),l.class=="Necromancer"&&h.push(`images/classes/Necromancer_${f(3)+1}.png`),l.class=="Witcher"&&h.push("images/classes//Witcher.png"),l.class=="Archer"&&h.push("images/classes//Archer.png"),l.class=="Thief"&&h.push(`images/classes/Thief_${f(4)+1}.png`),l.class=="Healer"&&h.push(`images/classes/Healer_${f(3)+1}.png`),l.class=="Cowcat"&&h.push(`images/classes/Cowcat_${f(3)+1}.png`),l.class=="Bard"&&h.push(`images/classes/Bard_hat_${f(4)+1}.png`),l.class=="Warrior"&&h.push(`images/classes/Warrior_helmet_${f(4)+1}.png`),l.class=="Druid"&&h.push(`images/classes/Druid_${f(7)+1}.png`),l.race=="Mercat"&&h.push(`images/races/Mercat_${f(3)+1}.png`),h.push(`images/body/whiskers_${f(3)+1}.png`),h.push("images/watermark.png"),h.push("images/frame.png"),Ds(),vs.innerText=l.name[0]+l.name[1]+l.name[2]+" of the "+l.origin[0]+l.origin[1]+l.origin[2],xs.innerText="Class: "+l.class,Ts.innerText="Race: "+l.race}function As(){Gr(_e).then(function(t){let e=document.createElement("a");e.download="my-fantasy-cat.jpeg",e.href=t,e.click()})}function Ps(){let t={name:[Xe[f(74)],ys[f(12)],bs[f(76)]],class:_s[f(11)],race:ws[f(8)],colour:Cs[f(8)],origin:[Ss[f(32)],Es[f(22)]," "+Ye[f(12)]]};return t.race=="Vulcan"&&(t.name[0]=Xe[f(8)]),t.race=="Mercat"&&(t.origin[2]=" "+Ye[f(3)]),t}async function Ds(){_e.style="filter: blur(5px) brightness(0.5);",Ze.style="opacity: 10";let t=h.length;for(let e=0;e<=t;e++)await new Promise(function(n){let r=new Image;r.src=h[e],r.onload=()=>{It.drawImage(r,0,0),e==t-1&&(_e.style="",Ze.style="opacity: 0"),n()}})}function Rs(){It.clearRect(0,0,573,844),l={},h=[]}function f(t){return Math.floor(Math.random()*t)}new cursoreffects.fairyDustCursor({colors:["#d8a0ff","#b996ff","#fff9ff"]});const Bs={apiKey:"AIzaSyAXMAK8q4eDi3XsHJWn1_wvywp6B042R4I",authDomain:"fantasy-cat-generator.firebaseapp.com",projectId:"fantasy-cat-generator",storageBucket:"fantasy-cat-generator.appspot.com",messagingSenderId:"206567743551",appId:"1:206567743551:web:263d99027d6b9a7688588a"};function Os(){let t=navigator.userAgent.indexOf("Chrome")>-1;return navigator.userAgent.indexOf("Safari")>-1?!t:!1}Wn(Bs);window.onload=Pt();Is.addEventListener("click",Pt);At.addEventListener("click",As);
